...
public class InitialDemoConfigData4DBDemoMulti extends UnitilsJUnit4 {
    protected static transient Logger log = LoggerFactory.getLogger(InitialDemoConfigData4DBDemoMulti.class);
    @SpringBeanByName
    ...
    public void initialConfigData() throws Exception {
        String baseTaskTypeName = "DBDemoMulti";
        ...
        baseTaskType.setDealBeanName("dbDemoMulti");
...
//                + "4:{TYPE=A,KIND=5},5:{TYPE=A,KIND=6},6:{TYPE=A,KIND=7},7:{TYPE=A,KIND=8}," + "8:{TYPE=A,KIND=9},9:{TYPE=A,KIND=10}"));
        ...
        // 创建任务DemoTask的调度策略
        String taskName = baseTaskTypeName + "$BASE";
